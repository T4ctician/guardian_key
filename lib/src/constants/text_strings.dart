...
const String tNotebox = "Search Note";
const String tCardSearchbox = "Search Credit Card";
...
const String termsandcondition = '''
END-USER LICENSE AGREEMENT
Updated at September 27th, 2023
Guardian Key hereby grants you access to (“the app”) and invites you to purchase the services offered here.
...
● Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Guardian Key LLP, (6
Shenton Way, OUE Downtown 2, Singapore 068809), that is responsible for your information under this
Eula.
● Country: where Guardian Key or the owners/founders of Guardian Key are based, in this case is
Singapore
● Service: refers to the service provided by Guardian Key as described in the relative terms (if available)
...
● App/Application: Guardian Key app, refers to the SOFTWARE PRODUCT identified above.
● You: a person or entity that is registered with Guardian Key to use the Services.
...
or “your”) and Guardian Key LLP (“Company”, “we”, “us” or “our”). This Agreement governs the relationship
between you and us, and your use of the Company Guardian Key. Throughout this Agreement, End User
and Company may each be referred to as a “Party” or collectively, the “Parties”.
If you are using the app on behalf of your employer or other entity (an “Organisation”) for whose benefit you
utilise the app or who owns or otherwise controls the means through which you utilise or access the app,
...
acknowledge, warrant, and covenant that you have the authority to 1) purchase a license to the app on
...
acknowledge that you have read and that you understand this agreement; (d) represent that you are of
sound mind and of legal age (18 years of age or older) to enter into a binding agreement; and (e) accept and
...
The Application is licensed, not sold, to you by Guardian Key for use strictly in accordance with the terms of
this Agreement.
License
Subject to the terms of this Agreement and, if applicable, those terms provided in the License Agreement,
Guardian Key grants you a limited, non-exclusive, perpetual, revocable, and non-transferable license to:
...
Guardian Key or its affiliates, partners, suppliers or the licensors of the Application.
...
are part of the Software that are otherwise owned by Guardian Key shall always remain the exclusive
property of Guardian Key (or of its suppliers or licensors, if and when applicable). Nothing in this Agreement
grants you (or any Organisation) a license to Guardian Key’s Intellectual Property Rights.
You agree that this is Agreement conveys a limited license to use Guardian Key’s Intellectual Property
Rights, solely as part of the Software (and not independently of it), and only for the effective Term of the
license granted to you hereunder. Accordingly, your use of any of Guardian Key’s Intellectual Property Rights

independently of the Software or outside the scope of this Agreement shall be considered an infringement of
Guardian Key’s Intellectual Property Rights. This shall not limit, however, any claim Guardian Key may have
for a breach of contract in the event you breach a term or condition of this Agreement. You shall use the
highest standard of care to safeguard all Software (including all copies thereof) from infringement,
misappropriation, theft, misuse or unauthorised access. Except as expressly granted in this Agreement,
Guardian Key reserves and shall retain all rights, title, and interest in the Software, including all copyrights
and copyrightable subject matter, trademarks and trademark able subject matter, patents and patentable
subject matter, trade secrets, and other intellectual property rights, registered, unregistered, granted,
...
to Guardian Key with respect to the Application shall remain the sole and exclusive property of Guardian
Key.
Guardian Key shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and
in any way without any credit or any compensation to you.
Modifications to Application
Guardian Key reserves the right to modify, suspend or discontinue, temporarily or permanently, the
Application or any service to which it connects, with or without notice and without liability to you.
Updates to Application
Guardian Key may from time to time provide enhancements or improvements to the features/ functionality of
the Application, which may include patches, bug fixes, updates, upgrades and other modifications
("Updates").
Updates may modify or delete certain features and/or functionalities of the Application. You agree that
Guardian Key has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular
...
You acknowledge and agree that Guardian Key shall not be responsible for any Third-Party Services,
including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality
or any other aspect thereof. Guardian Key does not assume and shall not have any liability or responsibility
...
This Agreement shall remain in effect until terminated by you or Guardian Key.
Guardian Key may, in its sole discretion, at any time and for any or no reason, suspend or terminate this
Agreement with or without prior notice.
This Agreement will terminate immediately, without prior notice from Guardian Key, in the event that you fail
...
Termination of this Agreement will not limit any of Guardian Key’s rights or remedies at law or in equity in
case of breach by you (during the term of this Agreement) of any of your obligations under the present
Agreement.
Indemnification
You agree to indemnify, defend and hold harmless Guardian Key and its officers, directors, employees,
agents, affiliates, successors, and assigns from and against any and all losses, damages, liabilities,
deficiencies, claims, actions, judgments, settlements, interest, awards, penalties, fines, costs, or expenses of
whatever kind, including reasonable attorneys’ fees, arising from or relating to: i) your use or misuse of the
...
third party. Furthermore, you agree that Guardian Key assumes no responsibility for the information or
content you submit or make available through this Software or the content that is made available to you by
third parties.
No Warranties
The Application is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without
warranty of any kind. To the maximum extent permitted under applicable law, Guardian Key, on its own
...
Without limitation to the foregoing, Guardian Key provides no warranty or undertaking, and makes no
...
corrected.
Without limiting the foregoing, neither Guardian Key nor any Guardian Key’s provider makes any
...
provided through the Application; or (iv) that the Application, its servers, the content, or e-mails sent from or
on behalf of Guardian Key are free of viruses, scripts, trojan horses, worms, malware, time bombs or other
harmful components.
...
Notwithstanding any damages that you might incur, the entire liability of Guardian Key and any of its
...
To the maximum extent permitted by applicable law, in no event shall Guardian Key or its suppliers be liable
...
any provision of this Agreement), even if Guardian Key or any supplier has been advised of the possibility of
...
Guardian Key reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
...
acceptance, you are no longer authorised to access or use the app.
No Employment or Agency Relationship
No provision of this Agreement, or any part of relationship between you and Guardian Key, is intended to
create nor shall they be deemed or construed to create any relationship between you and Guardian Key
other than that of and end user of the app and services provided.
Equitable Relief
You acknowledge and agree that your breach of this Agreement would cause Guardian Key irreparable harm
for which money damages alone would be inadequate. In addition to damages and any other remedies to
which Guardian Key may be entitled, you acknowledge and agree that we may seek injunctive relief to
...
The Company is based in Singapore and provided for access and use primarily by persons located in
Singapore, and is maintains compliance with Singapore laws and regulations. If you use the app from
outside Singapore, you are solely and exclusively responsible for compliance with local laws.
...
permanently barred.
Entire Agreement
The Agreement constitutes the entire agreement between you and Guardian Key regarding your use of the
Application and supersedes all prior and contemporaneous written or oral agreements between you and
Guardian Key.
You may be subject to additional terms and conditions that apply when you use or purchase other Guardian
Key’s services, which Guardian Key will provide to you at the time of such use or purchase.
Contact Us
Don't hesitate to contact us if you have any questions about this Agreement.
● Via this Address: 6 Shenton Way, OUE Downtown 2, Singapore 068809
